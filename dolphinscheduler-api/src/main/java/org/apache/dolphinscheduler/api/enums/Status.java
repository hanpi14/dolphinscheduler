...
public enum Status {
    ...
    USER_AUTHEN_NULL(10005, "user name is not authentication", "用户名未认证"),
    ...
    // 添加
    QUERY_ALL_PROJECT_ON_MANAGER_ERROR(10201, "The integrated management platform failed to query the item list",
            "集成管理平台查询项目列表错误"),
